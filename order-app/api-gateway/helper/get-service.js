...
module.exports = {
  async parseService(serviceName) {
    switch (serviceName) {
      case 'category':
        return process.env.category_service_url;
        break;
      case 'product':
      ...
      case 'auth':
        ...
        break;
      case 'customer':
        return process.env.customer_service_url;
        break;
      case 'option':
      ...
      case 'order':
        ...
        break;
      case 'sube':
        return process.env.sube_service_url;
        break;
      default:
        return 'hatali';
    }
  ...
  async loggerInfo(method, name, url, params, type, error) {
    ...
    switch (type) {
      case 'info':
        logger.info(
          `Method = ${method} Service Name = ${name} Service Url = ${url} Service Param = ${JSON.stringify(
            params,
          )}`,
        );
        console.info(
