    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="(item, index) in BilkentData.data" :key="item._id">
          ...
          <td>
            {{
              BilkentData.programData[index] === undefined
                ? 0
                : BilkentData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in BilkentData.data" :key="item._id">
            ...
            <td>
              {{
                BilkentData.programData[index] === undefined
                  ? 0
                  : BilkentData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in BilkentData.data" :key="item._id">
            ...
            <td>
              {{
                BilkentData.programData[index] === undefined
                  ? 0
                  : BilkentData.programData[index]["YEMEKSEPETI"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in BilkentData.data" :key="item._id">
            ...
            <td>
              {{
                BilkentData.programData[index] === undefined
                  ? 0
                  : BilkentData.programData[index]["YEMEKCEKI"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in BilkentData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  BilkentData.VegaKasa[index] === undefined
                    ? 0
                    : BilkentData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.BilkentData);
    },
  },
};
</script>
