    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="(item, index) in UmitkoyData.data" :key="item._id">
          ...
          <td>
            {{
              UmitkoyData.programData[index] === undefined
                ? 0
                : UmitkoyData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in UmitkoyData.data" :key="item._id">
            ...
            <td>
              {{
                UmitkoyData.programData[index] === undefined
                  ? 0
                  : UmitkoyData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in UmitkoyData.data" :key="item._id">
            ...
            <td>
              {{
                UmitkoyData.programData[index] === undefined
                  ? 0
                  : UmitkoyData.programData[index]["YEMEKSEPETI"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in UmitkoyData.data" :key="item._id">
            ...
            <td>
              {{
                UmitkoyData.programData[index] === undefined
                  ? 0
                  : UmitkoyData.programData[index]["YEMEKCEKI"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in UmitkoyData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  UmitkoyData.VegaKasa[index] === undefined
                    ? 0
                    : UmitkoyData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.UmitkoyData);
    },
  },
};
</script>
