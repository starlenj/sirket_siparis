    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="(item, index) in MersinData.data" :key="item._id">
          ...
          <td>
            {{
              MersinData.programData[index] === undefined
                ? 0
                : MersinData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in MersinData.data" :key="item._id">
            ...
            <td>
              {{
                MersinData.programData[index] === undefined
                  ? 0
                  : MersinData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in MersinData.data" :key="item._id">
            ...
            <td>
              {{
                MersinData.programData[index] === undefined
                  ? 0
                  : MersinData.programData[index]["YEMEKSEPETI"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in MersinData.data" :key="item._id">
            ...
            <td>
              {{
                MersinData.programData[index] === undefined
                  ? 0
                  : MersinData.programData[index]["YEMEKCEKI"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in MersinData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  MersinData.VegaKasa[index] === undefined
                    ? 0
                    : MersinData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.MersinData);
    },
  },
};
</script>
