          ...
          <td>
            {{
              GordionData.programData[index] === undefined
                ? 0
                : GordionData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in GordionData.data" :key="item._id">
            ...
            <td>
              {{
                GordionData.programData[index] === undefined
                  ? 0
                  : GordionData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in GordionData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  GordionData.VegaKasa[index] === undefined
                    ? 0
                    : GordionData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.GordionData);
    },
  },
};
</script>
