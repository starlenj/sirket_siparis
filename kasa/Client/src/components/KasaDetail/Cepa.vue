    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="(item, index) in CepaData.data" :key="item._id">
          ...
          <td>
            {{
              CepaData.programData[index] === undefined
                ? 0
                : CepaData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in CepaData.data" :key="item._id">
            ...
            <td>
              {{
                CepaData.programData[index] === undefined
                  ? 0
                  : CepaData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in CepaData.data" :key="item._id">
            ...
            <td>
              {{
                CepaData.programData[index] === undefined
                  ? 0
                  : CepaData.programData[index]["YEMEKSEPETI"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in CepaData.data" :key="item._id">
            ...
            <td>
              {{
                CepaData.programData[index] === undefined
                  ? 0
                  : CepaData.programData[index]["YEMEKCEKI"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in CepaData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  CepaData.VegaKasa[index] === undefined
                    ? 0
                    : CepaData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.CepaData);
    },
  },
};
</script>
