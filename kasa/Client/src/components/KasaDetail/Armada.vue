          ...
          <td>
            {{
              ArmadaData.programData[index] === undefined
                ? 0
                : ArmadaData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in ArmadaData.data" :key="item._id">
            ...
            <td>
              {{
                ArmadaData.programData[index] === undefined
                  ? 0
                  : ArmadaData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in ArmadaData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  ArmadaData.VegaKasa[index] === undefined
                    ? 0
                    : ArmadaData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.ArmadaData);
    },
  },
};
</script>
