    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="(item, index) in BatikentData.data" :key="item._id">
          ...
          <td>
            {{
              BatikentData.programData[index] === undefined
                ? 0
                : BatikentData.programData[index]["KREDI"]
            }}
          </td>
          <td>
            {{
          ...
          <tr v-for="(item, index) in BatikentData.data" :key="item._id">
            ...
            <td>
              {{
                BatikentData.programData[index] === undefined
                  ? 0
                  : BatikentData.programData[index]["NAKIT"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in BatikentData.data" :key="item._id">
            ...
            <td>
              {{
                BatikentData.programData[index] === undefined
                  ? 0
                  : BatikentData.programData[index]["YEMEKSEPETI"]
              }}
            </td>
            <td>
              {{
          ...
          <tr v-for="(item, index) in BatikentData.data" :key="item._id">
            ...
            <td>
              {{
                BatikentData.programData[index] === undefined
                  ? 0
                  : BatikentData.programData[index]["YEMEKCEKI"]
              }}
            </td>
            <td>
              {{
        ...
        <tbody>
          <tr v-for="(item, index) in BatikentData.data" :key="item._id">
            ...
            <td>
              {{
                parseFloat(
                  BatikentData.VegaKasa[index] === undefined
                    ? 0
                    : BatikentData.VegaKasa[index].TLGIDER
                ).toFixed(2)
              }}
            </td>
            <td>
...
export default {
  ...
  methods: {
    async GetKasa() {
      ...
      console.log("BAHÇELİ PROGRAM DATA", this.BatikentData);
    },
  },
};
</script>
