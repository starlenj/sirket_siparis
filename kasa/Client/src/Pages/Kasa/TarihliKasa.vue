<template>
  <div>
    <div v-if="!HaveReport">
        ...
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4>
              ...
              <span class="font-weight-semibold">Kasa</span> - Kasa Durum
            </h4>
        ...
        >
          <div class="d-flex">
            <div class="breadcrumb">
              ...
              <a href="/Sube" class="breadcrumb-item">Kasa Durum</a>
            </div>
      ...
      <div class="content">
        ...
        <div class="page has-sidebar-left bg-light height-full">
           <div>
              <label>Tarih :</label>
              <input type="date" v-model="model.tarih" @change="ChangeDate" />
          </div>
                      ...
                      <td>
                        ...
                        >
                          <button
                            ...
                            data-toggle="modal"
                            data-target="#showImage"
                            @click="SelectImage(model.iade.resimAlti)"
                          >
                            Göster
                          </button>
                        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <p>
                    Rapor Gönderilecek Düzenleme Yapamazsınız Onaylıyor
                    musunuz?.
                  </p>
                </div>
    ...
    <div class="page has-sidebar-left bg-light height-full" v-show="HaveReport">
      <h4>
        Gönderilecek Bir Gün Sonu Bulunmamaktadır..Güncelleme İçin Merkezle
        İletişime Geçiniz..
      </h4>
    </div>
  </div>
...
export default {
  ...
  methods: {
    async ShopReportSave() {
        if (this.model.tarih === "") { 
            alert("Tarih Bos Olamaz!!!!");
            return;
        }
      /* this.model.ticket.forEach((item)=>{
          // eslint-disable-next-line no-console
        console.log(item)
      })*/
      let result = await Service.save("shopReportView", {
        sodexo: this.model.sodexo,
        ticket: this.model.ticket,
        cash: this.model.nakit,
        credit: this.model.pos,
        masraf: this.model.masraf,
        created_at: moment(this.model.tarih).format("YYYY.MM.DD"),
    ...
    async ChangeDate(e) {
        this.model.tarih = e.target.value;
         let check = await Service.save("/ShopReportView/CheckReport", {
      subeId: this.UserInfo.subeId,
  ...
  let ShopResponse = await Service.save("shopReportView/GetReport", {
      subeId: this.UserInfo.subeId,
      date: moment(e.target.value).format("YYYY.MM.DD"),
    });
    ...
    this.ReportId = ShopResponse[0];
    this.model.sodexoGunSonu = parseFloat(ShopResponse[0].sodexoGunSonu);
    this.model.ticketGunSonu = parseFloat(ShopResponse[0].ticketGunSonu);
  ...
  async mounted() {
    ...
    let ShopResponse = await Service.save("shopReportView/GetReport", {
      subeId: this.UserInfo.subeId,
      date: moment(this.model.tarih).format("YYYY.MM.DD"),
    });
    ...
    this.model.sodexoGunSonu = parseFloat(this.model.sodexoGunSonu);
    this.model.ticketGunSonu = parseFloat(this.model.ticketGunSonu);
