<template>
  <div>
    ...
    <div class="page has-sidebar-left bg-light height-full">
      ...
      <div class="col-lg-12">
        <div class="card shadow mb-4">
          <div class="card-header py-3">Transferler</div>
          <div class="card-body">
            <table class="table">
              <thead>
...
export default {
  ...
  methods: {
    ...
    async SiparisOnayla() {
      await SepetService.SepetOnay(this.model.orderData);
      setInterval(() => {
  ...
  beforeMount() {
    this.columnDefs = [
      { headerName: "Malın Cinsi", field: "MALINCINSI", filter: true },
      { headerName: "Miktar", field: "miktar", filter: true }
    ];
  }
};
</script>
